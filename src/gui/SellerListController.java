...
public class SellerListController implements Initializable, DataChangeListener {
	...
	@FXML
	private TableColumn<Seller, String> tableColumnEmail; // referencia da coluna Email
	
	@FXML
	private TableColumn<Seller, Date> tableColumnBirthDate; // referencia da coluna Data de nascimento
	
	@FXML
	private TableColumn<Seller, Double> tableColumnBaseSalary; // referencia da coluna Salario
