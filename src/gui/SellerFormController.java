...
public class SellerFormController implements Initializable {
	...
	public void onBtSaveAction(ActionEvent event) {
		if (entity == null) {
			throw new IllegalStateException("Entity was null"); // exceção para tratar entidades nula
		}
		if (service == null) {
			throw new IllegalStateException("Service was null"); // exceção para tratar serviços nulo
		}
		try {
			entity = getFormData();
			service.saveOrUpdate(entity);
			notifyDataChangeListeners();
			Utils.currentStage(event).close();// fecha a janela do formulario
